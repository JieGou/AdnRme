...
namespace AdnRme
{
    ...
    internal class CmdElectricalHierarchy2 : IExternalCommand
    {
            ...
            try
            {
                ...
                List<Element> equipment;
                {
                    ...
                    foreach (FamilyInstance e in equipment)
                    {
                        ...
                        {
                            Debug.Assert(1 == systems2.Size/*Count*/,
                    ...
                    Debug.WriteLine($"Retrieved {n} circuit element{Util.PluralSuffix(n)}...");
                    n = 0;
                    foreach (Element e in circuitElements)
                    {
                        ...
                        else
                        {
                            ...
                            Debug.Assert(0 < systems2.Size/*Count*/, "expected circuit element to belong to an electrical system");
                    ...
                    Debug.WriteLine($"{n} circuit element{Util.PluralSuffix(n)} were the electrical systems.");
                    //
